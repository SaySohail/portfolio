...
export const StickyScroll = ({ content, contentClassName, onScrollEnd }) => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (isAtBottom) {
        onScrollEnd(true); // Notify that the scroll has reached the end
      }
    };
      ...
      <div className="container mx-auto">
        ...
        <div>
          <motion.div
            ...
            className="h-[35rem] overflow-y-auto  flex  justify-start md:justify-between relative space-x-10 rounded-md p-2 md:p-10 hide-scrollbar overflow-x-hidden"
            ref={ref}
          >
              ...
              <div className="max-w-2xl">
                {content.map((item, index) => (
                  <div key={item.companyName + index} className="my-20">
                    ...
                    <ul className="flex flex-col space-y-2 mt-2 list-disc">
