  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:w-[450px] md:w-[450px] relative rounded-2xl border  flex-shrink-0 border-slate-700 px-8 py-6 bg-tertiary dark:bg-secondary/40"
